...
console.log(notas, notas>=7) // notas é o resultado de nota1 + nota2, logo após tem a resposta da pergunta "verifique se o resultado é maior ou igual a 7."
...
let cidadeNatalMinuscula = cidadeNatal.toLowerCase() // criei uma variavel com a string escrita em letras minusculas

console.log(cidadeNatalMinuscula, cidadeNatalMinuscula.includes("ife")) // criei uma variável com todas as letras minusculas, logo após "perguntei" ao terminal se havia a palavra "ife" na 
//variavel "cidadeNatalMinuscula"
...
saboresDeSorvete.push("limão") // adicionei a string "limão" à variável
saboresDeSorvete.shift() // removi a primeira string da variável

console.log(saboresDeSorvete) // imprimi a variável com a palavra "limão", e sem a primeira palavra da array
...
const anoNascimento = 2000 // criei a variável "anoNascimento"
let idade = 2024-anoNascimento // criei a variável com o ano atual (2024) menos o "anoNascimento"  

console.log(idade, idade > 18) // imprimi a variavel com a idade ("idade"), e perguntei ao terminal se o resultado é maior que 18

// 19. Declare uma variável chamada `curso` com o valor " JavaScript ". Remova os espaços em branco, converta a string para letras maiúsculas e armazene o resultado em uma nova variável
//chamada `cursoAjustado`.

let curso = " JavaScript " // criei a variável "curso" com o valor " JavaScript "
curso = curso.trim() // removi os espaços em branco da variável
curso = curso.toUpperCase() // converti a variável para letras maiusculas
let cursoAjustado = curso // armazenei a variável "curso" na nova variável chamada "cursoAjustado"

console.log(cursoAjustado) // imprimi a variável no terminal
...
console.log(email.trim(), email.includes("@"))
...
// 24. Crie uma variável chamada `mensagem2` com o valor "Bem-vindo ao curso de JavaScript!". Verifique se a string inclui a palavra "curso" e depois converta toda a string para letras 
//minúsculas.
...
// 25. Crie uma constante chamada `preco1` com o valor 50 e outra chamada `preco2` com o valor 80. Verifique se o `preco1` é menor que o `preco2` e armazene o resultado em uma variável 
//chamada `precoComparado`.
...
// 28. Crie uma variável chamada `frase` com o valor "Aprender JavaScript é divertido". Verifique se a string inclui a palavra "divertido" e depois converta toda a string para letras 
//maiúsculas.
