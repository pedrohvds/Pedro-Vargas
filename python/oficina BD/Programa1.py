...
# Função para atualizar um usuário através do ID

def update_Usuario_id(id, new_name, new_senha, new_e_mail, new_age):
...
def main():
    while True:
        ...
        print("5. Atualizar usuário com o ID")
        print("6. Sair")
        ...
        if choice == '1':
            ...
            list_Usuarios()
            id = input("ID ser atualizado: ")
            new_name = input("Nome: ")
            new_senha = input('Senha: ')
            new_e_mail = input('E-mail: ')
            new_age = int(input("Nova idade: "))
            update_Usuario_id(id, new_name, new_senha, new_e_mail, new_age)
        elif choice == '6':
            print("Saindo...")
            break
        else:
